            ...
            $.req({
                ...
                success(res) {
                    if (res.data.length) {
                        ...
                        $('#order').append('<div class="emptyContainer" ><img src = "../assets/pc/images/icon/empty@2x.png" /><p>Your have not ordered anything yet</p><a href="productList.html" class="button" type="button" class="content_btn">CONTINUE SHOPPING</a></div > ')
                    }
                }
            });
        });
