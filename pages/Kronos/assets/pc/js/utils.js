    ...
    for (let i = 0; i < data.length; i++) {
      if (!$.isEmptyObject(data[i])) {
        html += `<div class="swiper-slide" sort="${data[i].sort}" start="${data[i].discountStaTime}" end="${data[i].discountEndTime}">
                  ...
                  <div class="img-box cover_wrap"><div class="quick-shop">Quick Shop</div>`
        if (data[i].freeShipping !== 0) {
          html += '<div class="discount-shipping">Free Shipping</div>'
        }
      ...
      if (!$.isEmptyObject(data[i])) {
        ...
        <a href='productDetail_${data[i].id}.html${promotionLogo}' class="loading">
          <div class="madal alginCenter">
            <button onclick="routerJump('productDetail_${data[i].id}.html${promotionLogo}')">Quick Shop</button>
          </div>`
        if (data[i].discount && data[i].discount != 10) {
        ...
        if (data[i].freeShipping !== 0) {
          ...
          var html3 = `<div class="freeLabel">Free Shipping</div>`
        } else {
          var html3 = ''
        }
        if (data[i].otherImg) {
