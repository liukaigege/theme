            ...
            if (isClick) {
              if (cartRes.invalidGoodsList.length) {
                ...
                if (money !== '0') {
                  ...
                  alert("Votre demande n'a pas pu être exécutée parce que la validation de l'entreprise était incorrecte et a échoué. Le montant ne doit pas être inférieur à zéro.")
                }
              }
            }
          }
