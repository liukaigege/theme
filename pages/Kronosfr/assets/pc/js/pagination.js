...
function creatBtns(ismorePosition) {
  ...
  var prevbtn = '<span class="" id="pagination-prev"><img  src="../assets/pc/images/left@2x.png" alt=""></span>';
  var nextbtn = '<span  id="pagination-next"><img src="../assets/pc/images/right@2x(1).png" alt=""></span>'
  if (this._currentPage == 1) {
    firstbtn = '<li class="pagenum pagination-btn pagination-current" data-num="1">1</li>';
    prevbtn = '<span class=" pagination-disabled" id="pagination-prev"><img src="../assets/pc/images/left@2x.png" alt=""></span>'
  }
  if (this._currentPage == this._btnNum) {
    ...
    nextbtn = '<span class=" pagination-disabled" id="pagination-next"><img src="../assets/pc/images/right@2x(1).png" alt=""></span>'
  }
...
function bindEvent() {
  var that = this;
  /*页码点击*/
  $(that._wrapid +' .pagenum').bind('click', function () {
...
(function () {
  ...
  Pagination.prototype = {
    render: function (obj) {
      // 总数据小于每页数据时，不加载分页组件
      if (obj.total <= obj.pagesize) return
      /*显示分页器的容器元素id*/
